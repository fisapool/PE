/**
 * Basic tests for ProxyNetworkServer
 */

// Must mock winston BEFORE importing ProxyNetworkServer
jest.mock('winston', () => ({
...
// Mock dependencies
jest.mock('../../../src/client/ProxyAPIClient');
...
describe('ProxyNetworkServer', () => {
  ...
  test('should generate API keys', () => {
    ...
    const apiKey = server.generateApiKey('device-123', 'user');
